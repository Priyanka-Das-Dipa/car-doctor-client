    ...
    <div>
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute flex rounded-lg items-center h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] gap-5">
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute rounded-lg flex items-center h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] gap-5">
            <div className="text-white space-y-4 w-1/2 ml-10">
              <h1 className="text-7xl font-semibold">
                Affordable Price For Car Servicing
              </h1>
        ...
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <div className="absolute flex rounded-lg items-center h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] gap-5">
            <div className="text-white space-y-4 w-1/2z ml-10">
              <h1 className="text-7xl font-semibold">
                Affordable Price For Car Servicing
              </h1>
              <p className="text-xl font-medium">
